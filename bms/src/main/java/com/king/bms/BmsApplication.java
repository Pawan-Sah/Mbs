...
public class BmsApplication {
    ...
    public static void main(String[] args) {
		...
		//.acceptMovieDetails(movie3);
		//movieService.acceptMovieDetails(movie4);
		//Movie findMovie=movieDao.findById(2).get();
		System.out.println("<----->>>>");
		System.out.println(movie.getMovieName());
		String s="Iron Man";
		Movie findMovie=movieDao.findMovieByMovieName(s);
       ...
       /* City city1 = new City();
        ...
        List<Theater> theaters = theaterDao.findAllByCity(city1);*/
